...
from database import SessionLocal, init_db, get_async_session
from models import TickerEntry, Intraday, TickerInfo, Intraweek, WatchlistEntry
...
@app.delete("/users/me/watchlist/{ticker_symbol}", status_code=204, tags=["watchlist"])
...
@app.get(
    "/users/me/watchlist/{ticker_symbol}",
